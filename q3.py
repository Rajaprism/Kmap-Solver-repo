...
#func_True,func_DC order of list
#testcases
#(["a'b'"],["ab'"])
#(["a'b'c'","a'b'c",],["a'bc","a'bc'"])
#(["a'b'c'd'","a'b'c'd","abcd"],["abc'd","abcd'"])
#(["a'b'c'd'","a'b'c'd","abcd"],["abc'd"])
#(["a'bc'd'", "abc'd'", "a'b'c'd", "a'bc'd", "a'b'cd"],["abc'd"])
#comb_function_expansion(["a'bc'd'", "abc'd'", "a'b'c'd", "a'bc'd", "a'b'cd"],["abc'd"])
comb_function_expansion(["a'b'c'd","a'b'cd",
 "a'bc'd", "abc'd'","abc'd", "ab'c'd'",
  "ab'cd"],["a'bc'd'", "a'bcd", "ab'c'd"])
